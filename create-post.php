...
<body>
    <main>
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Digite o título da postagem aqui..." aria-label="Título" />
        </div>
        <div class="input-group mb-3">
            <input name="tags" class="form-control" placeholder="Escreva as categorias separadas por vírgulas">
        </div>
        <div class="editor">
            <div class="toolbar">
