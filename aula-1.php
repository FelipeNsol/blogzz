                ...
                <div class="col-12 d-flex">
                    ...
                    <div class="col-9">
                        ...
                        <h6 style="color: #8899a8">Nessa aula você poderá ver o que fazer logo após adquirir o seu
                            acesso ao BotConversa. É importante que veja essa aula em especial com bastante atenção,
                            para que seja evitada possíveis dúvidas.</h6>
                        <br>
                        <div class="d-flex justify-content-center">
                            <div class="text-center my-4">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe width="800" height="500" src="https://www.youtube.com/embed/Rsj_z43oNRk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
